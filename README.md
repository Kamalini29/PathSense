...
> [!NOTE]
> **Defensible Engineering Scope:** PathSense does *not* train a new depth estimator or object detector from scratch. Its core technical contribution lies in the **Integration and Decision Layer**:
>
...
> 3. **Safe-Direction Decision Logic:** Rule-based directional router with Exponential Moving Average (EMA) and temporal hysteresis state machine to reduce frame flicker.
> 4. **Spatial Audio Panning Engine:** Equal-power binaural stereo panning and TTS synthesis.
>
> **Implementation Contribution:** Integrated percentile-based depth zoning with confidence-weighted object hazard fusion to produce a unified $3 \times 3$ spatial risk matrix.
